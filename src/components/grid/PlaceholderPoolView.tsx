              ...
              return (
                ...
                >
                  {hasImage ? (
                    ...
                    >
                      {item.text ? (
                        <span className="font-extrabold uppercase tracking-widest px-2 drop-shadow-md relative z-10 leading-tight text-white">
                          {item.text}
                        </span>
                      ) : (
                        <span className="text-white/90 text-center font-extrabold drop-shadow-md leading-tight w-full break-words px-2">
                          Draft
                        </span>
                      )}
                    </div>
        ...
        <div className="absolute bottom-3 inset-x-3 z-40 animate-in slide-in-from-bottom-3">
          <div className="bg-slate-900 text-white p-2.5 rounded-xl shadow-xl flex items-center justify-between">
            <span className="text-xs font-bold pl-1">
              {selectedIds.length}{" "}
              {selectedIds.length === 1 ? "Box Selected" : "Boxes Selected"}
            </span>
